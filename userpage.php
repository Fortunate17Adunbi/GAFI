...
<body>
	...
	<div class="main-div">
		...
		<div id="slideshow-example" data-component="slideshow" class="olo">
			<div role="list" class="show">
				...
				<div class="slide">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/GAFI.png?raw=true" alt="" width="400px" height="400px">
				</div>
				<div class="slide">
		...
		<div class="straight-image">
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1%20(9).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded img-fluid"><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1%20(9).jpg?raw=true"; ?>'>
			...
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (7).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded img-fluid"><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (7).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>
				</form>
			</div>			
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (3).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded img-fluid"><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (3).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>		
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (1).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded img-fluid"><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (1).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (12).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded img-fluid"><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/casuals/1 (12).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>
			<!-- <div class="over">
	...
	<div class="box-1">
		...
		<div class="straight-image">
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (4).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded " name="image"><br>
					<input type="hidden" value ='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (4).jpg?raw=true"; ?>'  name="img">
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>
				</form>					
			</div>								
			<div class="over">
				<form action='userpage.php' method='post'>
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (12).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded " name="image"><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (12).jpg?raw=true"; ?>'>
			...
			<div class="over">
				<form action="userpage.php" method="post">
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (13).jpg?raw=true"; ?>'>
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (13).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded "><br>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>					
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (9).jpg?raw=true" alt="" width="200px" height="200px" class="note rounded "><br>
					<input type="hidden" name="img" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/img/1 (9).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>				
				</form>
			</div>					
		</div>
	...
	<div class="box-1">	
		...
		<div class="straight-image">
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (1).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded "><br>
					<input type="hidden" name="image" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (1).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>			
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (3).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded "><br>
					<input type="hidden" name="image" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (3).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>		
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (11).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded "><br>
					<input type="hidden" name="image" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (11).jpg?raw=true"; ?>'>
			...
			<div class="over">
				<form action="userpage.php" method="post">
					<img src="https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (12).jpg?raw=true" alt="" width="150px" height="200px" class="note rounded "><br>
					<input type="hidden" name="image" value='<?php echo "https://github.com/Fortunate17Adunbi/GAFI-PROJECT/blob/master/shoe-collection/1 (12).jpg?raw=true"; ?>'>
					<button class="ano" type="submit" name="submit"><img src="https://cdn-icons-png.flaticon.com/512/3737/3737372.png" alt="Add to cart" width="20%" style="float: left;"> Add To Cart</button>					
				</form>
			</div>			
		</div>
